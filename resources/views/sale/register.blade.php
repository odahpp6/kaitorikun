    ...
    <form class="space-y-4">
        ...
        <div class="flex flex-wrap -mx-2">
            <div class="w-full md:w-1/3 px-2 mb-4">
                ...
                <input type="number" name="buy_price" min="0" class="w-full border border-gray-300 rounded px-3 py-2 text-right" required>
            </div>

            <div class="w-full md:w-1/3 px-2 mb-4">
                <label class="block text-sm font-bold mb-1">数量 <span class="text-red-500">必須</span></label>
                <input type="number" name="quantity" min="1" value="1" class="w-full border border-gray-300 rounded px-3 py-2 text-right" required >
            </div>
