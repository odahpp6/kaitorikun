...
@section('content')
<form  action="" ref="formEl" method="POST">
...
<div class="flex flex-wrap mb-4">
  <div class="w-fll md:w-1/2">
    <p class="text-sm text-stone-600 mb-2">卸先登録</p>
  </div>
  <div class="w-full md:w-1/2">
    <input type="text" class="border border-gray-600 rounded-lg p-2 w[90%]mb-4" name="master_wholesales">
  </div>
