...
<input type="submit" value="登録"  class="bg-blue-100 text-white px-6 py-2 rounded-lg hover:bg-blue-700 cursor-pointer transition-colors duration-200">
</form>
   ...
   <table class="w-full border border-gray-300 text-sm mb-4">
        ...
        <tbody>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="border px-2 py-1 whitespace-pre-wrap"><a href="/master/{{ $mastercampaign->id }}/dlete_campaign">削除</a></td>
            </tr>
            @endforeach
        </tbody>
